...
public class Speed : MonoBehaviour
{
    ...
    void AnswerAssignment4_2Update()
    {
    ...
    void AnswerAssignment4_2ConsumeFuel()
    {
        carFuel.fuelLevel = carFuel.fuelLevel - 10;
    }

    void AnswerAssignment4_2CheckFuelLevel()
    {
    ...
    void AnswerAssignment4_2CheckWeight()
    {
        if (carWeight < 1500)
        {
